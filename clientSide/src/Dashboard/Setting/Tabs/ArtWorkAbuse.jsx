...
const StyledTag = styled(Tag)(
  ({ theme }) => `
    ...
    line-height: 22px;
    background-color: ${
      theme.palette.mode === "dark" ? "rgba(255,255,255,0.08)" : "#E3EDFF"
    };
    ...
    <Box>
      <Box sx={{ mt: "20px" }}>
        <Typography sx={{ fontSize: "22px" }} variant="h4">
          Artworks Actually Report Abuse Settings
        </Typography>
        <Typography
          sx={{
            width: {
        ...
        >
          You can configure your Artwork abuse reports and add reasons for
          abusal from this settings menu. AA offers various customization.
        </Typography>
      </Box>
