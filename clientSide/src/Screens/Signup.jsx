...
const Signup = (props) => {
  const { signupPopUp, handleClose } = props;
  ...
  //this handler is for hide reset password screen
  ...
  return (
    <>
      ...
      >
        <div className="modal-content-compare rounded-3 mt-2 ms-2 p-0">
          {/* <form action=""></form> */}
